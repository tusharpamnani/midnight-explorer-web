      ...
      >
        ...
        <AlertDescription>
          <p className="mb-2 text-yellow-100/90">
            The Cardano node currently has an issue that caused the Midnight indexer to stop at block 2,637,734. 
            We’re aware of the problem and are working on a fix, so some new data may be temporarily unavailable.
          </p>
        </AlertDescription>
        <Button
          variant="ghost"
